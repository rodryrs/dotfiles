...
moonfly=[
			   ...
			   ['#ff5454', '#ff5454'],  #red [9]
			   ["#e3c78a", "#e3c78a"]  #yellow [
                ]

powerline=[
               ["#0a0b14", "#0a0b14"],  #background (dark grey) [0]
			   ["#f2d5cf", "#f2d5cf"],  #foreground (white) [2]
			   ["#161C2A", "#161C2A"],  #grey black [1]
			   ["#5E5E78", "#5E5E78"],    #ice grey[
			   ["#A3EB8C", "#A3EB8C"],  #green 1 [6]
			   ["#333947", "#333947"],  #grey 2 [4]
			   ["#434C5E", "#434C5E"],  #grey 3 [5]
			   ["#A3BE8C", "#A3BE8C"],   #green 2 [7]
			   ["#A9A9AB", "#A9A9AB"],  #ice [8]
			   ['#B8DAAD', '#B8DAAD'],  #green light[9]
			   ["#2D364B", "#2D364B"],  #grey 1 [3]
               ] 

qtilecustom=[
               ["#353446", "#353446"],  #background (dark grey) [0]
			   ["#f2d5cf", "#f2d5cf"],  #foreground (white) [2]
			   ["#b2b2b2", "#b2b2b2"],  #foreground (white) [2]
               ["#657B83", "#657B83"], # colorPerson
			   ["#ca9ee6", "#ca9ee6"],  #malva [4]
			   ["#CAA9E0", "#CAA9E0"],    #ice grey[
			   ['#B8DAAD', '#B8DAAD'],  #green light[9]
			   ['#B8DAAD', '#B8DAAD'],  #green light[9]
			   ['#B8DAAD', '#B8DAAD'],  #green light[9]
			   ]
